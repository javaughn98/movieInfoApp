$(document).ready(() =>{
    //retreive the title or name fo movie that was entered into the rearch bar
    ...
    function getMovies(searchText) {
        //use axios to request from the movie api
        axios.get('http://www.omdbapi.com/?apikey=751d2db1&s='+searchText)
        .then((response) => {
        ...
        <div class= "row">
                <div class="well">
                    ...
                    <hr>
                        ...
                        <a class="btn btn-default" href="index.html">Back to Search</a>            
                    </hr>
                </div>
        </div>
        `; 
